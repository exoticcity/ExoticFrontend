                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Card sx={{ mx: { xs: '1rem', lg: '29rem' }, width: { xs: '90vw', lg: '40vw' }, height: 'auto', p: '2.5rem', mt: '2rem' }}>
                        ...
                        <Box sx={{ pt: '2rem' }}>
                            ...
                            <TextField type="password" size="small" fullWidth onChange={(e) => setPassword(e.target.value)} {...register('password', { required: true })} />
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', alignItems: 'center', pt: '2rem' }}>
                            ...
                            <Link to='/VerifyEmail' style={{ textDecoration: 'none' }}>
                                <Tooltip title="Already a Business Central Customer?" placement="top">
                                    <Button size='small' sx={{ fontFamily: 'Montserrat', display: 'flex', justifyContent: 'space-between', px: '20px', fontSize: '13px', fontWeight: 600, backgroundColor: '#fff', color: '#000', transition: 'background-color 0.3s, color 0.3s', '&:hover': { backgroundColor: '#000', color: '#fff', }, }} variant='contained'>{t('Create Password')}</Button>
                                </Tooltip>
                            </Link>
